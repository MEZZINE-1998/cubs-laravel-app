...
<div class="container" id="app" style="margin-top: 100px">
      <div class="row">
          ...
          <div class="col-md-4 text-center" style="background-color: #fff; border-radius: 4px; padding: 30px; margin-bottom: 6px; box-shadow: 0px 0px 1px 1px rgba(0, 0, 0, .1); border-top: 5px solid #fc9330">
            ...
            <br>
            <span v-if="user.name && user.email && user.gender && user.matricule && user.password && user.passwordconfirm && user.categorie" style="cursor: pointer;" class="form-control btn btn-primary" @click="addUser">Ajouter</span>
          </div>
   	  </div>
   </div>
      ...
      methods:{
        ...
        addUser() {
          ...
          if (this.user.password != this.user.passwordconfirm) {
            ...
            // then send user
            axios.post(window.Laravel.url+"/addUser", this.user)
              .then(response =>{
