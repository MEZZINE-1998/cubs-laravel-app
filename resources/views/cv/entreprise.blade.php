            ...
            <div class="col-md-8">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <h5><b>Recruitments</b></h5>
                    </div>
                    @if(Auth::user()->id == $user->id)
                    <div class="col-md-6 text-right">
                      <i style="font-size: 16px; margin-right: 10px; margin-top: 7px" class="fa fa-plus-square" v-if="open == 0" @click="open = 1"></i>
                      <i style="font-size: 16px; margin-right: 10px; margin-top: 7px" class="fa fa-chevron-circle-up" v-if="open == 1" @click="open = 0, edit = 0"></i>
                    </div>
                    @endif
                  </div>

                  <span v-if="Recrutement.ings == null"> @{{ Recrutement.ings = [] }}</span>

                  <div v-if="open == 1 || Recrutement.ings.length != 0">
                    <form>
                      {{ csrf_field() }}
                      <li class="list-group-item" v-if="edit==0">
                        <p>Step 1 : Select engineers and scheduling interviews</p>
                        ...
                        <a href="{{url('cvs')}}">Add more engineers !!!</a><br><br>
                      </li>

                      <li class="list-group-item" v-if="edit==1">
                        <p>Step 1 : Update dates</p>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                         ...
                         <div v-for="condidat in Recrutement.id_condidats">
                           ...
                           <small style="margin-left: 10px">@{{ Recrutement.duree_entretien }} (interview duration)</small><br>
                         </div><br>
    ...
    var app = new Vue({
      ...
      methods:{
        ...
        send_validated_condidats:function(Recrutement){
          ...
          axios.post(window.Laravel.url+"/sendMailVal", Recrutement)
          .then(response =>{
            console.log("validation mail email")
          })
          .catch(error => {
