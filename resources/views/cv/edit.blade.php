   	  ...
   	  <div class="row">
            ...
            <li class="list-group-item ">
                 ...
                 <br>
                    ...
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label text-md-right" for="">Domain</label>
                     ...
                     <div class="form-group row">
                        ...
                        <label class="btn btn-light col-md-8" for="inputImageLabel">Update your image</label>
                        <input id="inputImageLabel" class="custom-file-input" type="file" name="photo" accept=".jpg, .jpeg, .png"  value="{{$cv->image}}">
                     </div>
                     <br>
